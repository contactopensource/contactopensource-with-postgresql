...
(
  CAST('cae9d8f8b5f982122ee0039a260ebbc2' as uuid), -- id
...
(
  CAST('0478736ed109d3e44f22e040fb00d75c' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
-- Example: Post by Bob
(
  CAST('b4d6797f1d3b9d4b94fbd60c8d03bd13' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('93c8a2a48e0c1723f15818e2b828ff34' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('b70416ab8424ddead9e13033be1f9625' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('dc5b7dd916e97afd5495ee662a9c56a1' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('996a7e7cc394b2b67410f52effef4153' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('d5496fc733a5910522a545b6e71d4223' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
-- Example: Post by Eve
(
  CAST('a37101f00c9a219f9e02df7bf2bdcc42' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('6a46a21195ed09ca6ff30878a9a06ac2' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('6f26bb5735d4bb06792bf3cabf4676bb' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
...
(
  CAST('f53d6bbda2c79ef6430fa05001b00c32' as uuid), -- id
  CAST('7bd380209cd310d3ad4e7f980298cbea' as uuid), -- tenant_id
  '', -- type_uri
  '', -- type_name
  '', -- state_uri
