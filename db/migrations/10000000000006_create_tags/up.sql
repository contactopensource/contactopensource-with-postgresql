...
CREATE INDEX ix_tags_type_uri on tags(type_uri);
CREATE INDEX ix_tags_type_name on tags(type_name);
CREATE INDEX ix_tags_state_uri on tags(state_uri);
CREATE INDEX ix_tags_state_name on tags(state_name);
