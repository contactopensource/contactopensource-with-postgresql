...
CREATE INDEX ix_contacts_type_uri on contacts(type_uri);
CREATE INDEX ix_contacts_type_name on contacts(type_name);
CREATE INDEX ix_contacts_state_uri on contacts(state_uri);
CREATE INDEX ix_contacts_state_name on contacts(state_name);
