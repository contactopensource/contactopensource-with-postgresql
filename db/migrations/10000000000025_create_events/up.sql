...
CREATE INDEX ix_events_type_uri on nodes(type_uri);
CREATE INDEX ix_events_type_name on nodes(type_name);
CREATE INDEX ix_events_state_uri on nodes(state_uri);
CREATE INDEX ix_events_state_name on nodes(state_name);
