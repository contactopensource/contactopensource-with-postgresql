...
CREATE INDEX ix_postal_contacts_type_uri on postal_contacts(type_uri);
CREATE INDEX ix_postal_contacts_type_name on postal_contacts(type_name);
CREATE INDEX ix_postal_contacts_state_uri on postal_contacts(state_uri);
CREATE INDEX ix_postal_contacts_state_name on postal_contacts(state_name);
