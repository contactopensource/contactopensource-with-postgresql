...
CREATE INDEX ix_email_contacts_type_uri on email_contacts(type_uri);
CREATE INDEX ix_email_contacts_type_name on email_contacts(type_name);
CREATE INDEX ix_email_contacts_state_uri on email_contacts(state_uri);
CREATE INDEX ix_email_contacts_state_name on email_contacts(state_name);
