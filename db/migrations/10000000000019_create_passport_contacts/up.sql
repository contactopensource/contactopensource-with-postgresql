...
CREATE INDEX ix_passport_contacts_type_uri on passport_contacts(type_uri);
CREATE INDEX ix_passport_contacts_type_name on passport_contacts(type_name);
CREATE INDEX ix_passport_contacts_state_uri on passport_contacts(state_uri);
CREATE INDEX ix_passport_contacts_state_name on passport_contacts(state_name);
