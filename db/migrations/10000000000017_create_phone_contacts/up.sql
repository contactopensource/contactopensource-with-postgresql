...
CREATE INDEX ix_phone_contacts_type_uri on phone_contacts(type_uri);
CREATE INDEX ix_phone_contacts_type_name on phone_contacts(type_name);
CREATE INDEX ix_phone_contacts_state_uri on phone_contacts(state_uri);
CREATE INDEX ix_phone_contacts_state_name on phone_contacts(state_name);
