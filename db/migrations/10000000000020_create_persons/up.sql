...
CREATE INDEX ix_persons_type_uri on persons(type_uri);
CREATE INDEX ix_persons_type_name on persons(type_name);
CREATE INDEX ix_persons_state_uri on persons(state_uri);
CREATE INDEX ix_persons_state_name on persons(state_name);
