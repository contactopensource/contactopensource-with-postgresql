...
CREATE INDEX ix_media_types_type_uri on media_types(type_uri);
CREATE INDEX ix_media_types_type_name on media_types(type_name);
CREATE INDEX ix_media_types_state_uri on media_types(state_uri);
CREATE INDEX ix_media_types_state_name on media_types(state_name);
