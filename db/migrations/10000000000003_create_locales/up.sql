...
CREATE INDEX ix_locales_type_uri on locales(type_uri);
CREATE INDEX ix_locales_type_name on locales(type_name);
CREATE INDEX ix_locales_state_uri on locales(state_uri);
CREATE INDEX ix_locales_state_name on locales(state_name);
